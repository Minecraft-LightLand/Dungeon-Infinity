...
public class VirtualShulkerScreen extends AbstractContainerScreen<VirtualShulkerMenu> {

	private static final Identifier CONTAINER_TEXTURE = Identifier.withDefaultNamespace("textures/gui/container/shulker_box.png");

	public VirtualShulkerScreen(VirtualShulkerMenu menu, Inventory inventory, Component title) {
