...
public class DefeatRoomTrigger extends BaseCriterion<DefeatRoomTrigger.Ins, DefeatRoomTrigger> {
	...
	@SerialClass
	public static class Ins extends BaseCriterionInstance<Ins, DefeatRoomTrigger> {
