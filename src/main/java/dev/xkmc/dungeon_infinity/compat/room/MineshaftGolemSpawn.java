	...
	public static void add(ConfigDataProvider.Collector map) {
		...
		// humanoid weapons
		{
			...
			map.add(GolemDungeons.ITEMS, ITEM_HUMANOID_RIDER_MELEE, new EquipmentConfig()
					...
					.add(EquipmentSlot.MAINHAND, 200, Items.IRON_SPEAR, 20)
			...
			map.add(GolemDungeons.ITEMS, ITEM_HUMANOID_BOW, new EquipmentConfig()
					.add(EquipmentSlot.MAINHAND, 100, Items.BOW, 15)
			...
			map.add(GolemDungeons.ITEMS, ITEM_HUMANOID_ROCKET, new EquipmentConfig()
					.add(EquipmentSlot.MAINHAND, 100, Items.CROSSBOW, 15)
		...
		// trial
		{
			...
			map.add(GolemDungeons.TRIAL, GolemSpawnData.MINESHAFT_QUAD, new TrialConfig().setReward(MazeRoomLootGen.MINESHAFT_QUAD)
					...
					.add(of(LARGE_3, 2), of(HUMANOID_MELEE, 1), of(HUMANOID_RIDER_MELEE, 1), of(HUMANOID_RIDER_RANGED, 2), of(HUMANOID_TIPPED, 1))
					.add(of(LARGE_3, 3), of(HUMANOID_MELEE, 2), of(HUMANOID_RIDER_MELEE, 2), of(HUMANOID_RIDER_RANGED, 3), of(HUMANOID_ROCKET, 1), of(HUMANOID_TIPPED, 1))
			);
			...
			map.add(GolemDungeons.TRIAL, GolemSpawnData.MINESHAFT_BOSS, new TrialConfig().setReward(MazeRoomLootGen.MINESHAFT_BOSS)
					...
					.add(of(LARGE_2, 3), of(HUMANOID_MELEE, 1), of(HUMANOID_RIDER_MELEE, 1), of(HUMANOID_RIDER_RANGED, 1), of(HUMANOID_TIPPED, 1))
			);
