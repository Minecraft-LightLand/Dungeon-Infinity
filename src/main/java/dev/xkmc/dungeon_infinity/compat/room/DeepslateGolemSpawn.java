...
public class DeepslateGolemSpawn extends AbstractGolemSpawn {

	public static Identifier loc(String id) {
		return DungeonInfinity.loc("deepslate/" + id);
	}
	...
	public static void add(ConfigDataProvider.Collector map) {
		...
		// metal golem equipments
		{
			map.add(GolemDungeons.ITEMS, ITEM_LARGE_ARMOR_1, new EquipmentConfig()
					...
					.add(EquipmentSlot.HEAD, 100, GolemItems.WINDSPIRIT_HELMET, 20)
					.add(EquipmentSlot.CHEST, 100, GolemItems.WINDSPIRIT_CHESTPLATE, 20)
					.add(EquipmentSlot.LEGS, 100, GolemItems.WINDSPIRIT_SHINGUARD, 20)
			);
			...
			map.add(GolemDungeons.ITEMS, ITEM_LARGE_SHOULDER, new EquipmentConfig()
					...
					.add(ExtraEquipmentSlot.RIGHT_SHOULDER, new EquipmentConfig.EquipmentEntry(
							100, GolemItems.FLAME_THROWER.get()))
					.add(ExtraEquipmentSlot.ARROW, new EquipmentConfig.EquipmentEntry(60))
					.add(ExtraEquipmentSlot.ARROW, new EquipmentConfig.EquipmentEntry(
							30, Items.FIRE_CHARGE))
					.add(ExtraEquipmentSlot.ARROW, new EquipmentConfig.EquipmentEntry(
							10, Items.TNT))
			);
		...
		// humanoid armors
		{
			map.add(GolemDungeons.ITEMS, ITEM_HUMANOID_ARMOR_MISC, new EquipmentConfig()
					...
					.add(EquipmentSlot.HEAD, 100, Items.DIAMOND_HELMET, 20)
					.add(EquipmentSlot.CHEST, 100, Items.DIAMOND_CHESTPLATE, 20)
					.add(EquipmentSlot.LEGS, 100, Items.DIAMOND_LEGGINGS, 20)
					.add(EquipmentSlot.FEET, 100, Items.DIAMOND_BOOTS, 20)
			);

			map.add(GolemDungeons.ITEMS, ITEM_HORSE_ARMOR, new EquipmentConfig()
					.add(EquipmentSlot.BODY, 50, Items.IRON_HORSE_ARMOR)
		...
		// humanoid weapons
		{
			...
			map.add(GolemDungeons.ITEMS, ITEM_HUMANOID_RIDER_MELEE, new EquipmentConfig()
					.add(EquipmentSlot.MAINHAND, 100, Items.DIAMOND_SPEAR, 30)
			...
			map.add(GolemDungeons.ITEMS, ITEM_HUMANOID_ROCKET, new EquipmentConfig()
					.add(EquipmentSlot.MAINHAND, 100, Items.CROSSBOW, 30)
					.add(EquipmentSlot.OFFHAND, 100, Items.FIREWORK_ROCKET, 14, 0)
			);
		}
		...
		// generic wave
		{
			map.add(GolemDungeons.SPAWN, MIXED, createBaseHumanoid().asTrialKey(GolemSpawnData.DEEPSLATE_BOSS)
					.type(GolemTypes.TYPE_GOLEM.get(), new SpawnConfig.GolemTypeEntry(30, 0)
		...
		// trial
		{
			...
			// BASIC: 基础混编
			map.add(GolemDungeons.TRIAL, GolemSpawnData.DEEPSLATE_ROOM_BASIC, new TrialConfig().setReward(MazeRoomLootGen.DEEPSLATE_ROOM_BASIC)
					.add(of(LARGE_1, 1), of(HUMANOID_MELEE, 1), of(HUMANOID_RANGED, 1))
			);

			// LARGE: 大型兵+远程护卫
			map.add(GolemDungeons.TRIAL, GolemSpawnData.DEEPSLATE_ROOM_LARGE, new TrialConfig().setReward(MazeRoomLootGen.DEEPSLATE_ROOM_LARGE)
			...
			// RANGED: 远程火力网+火箭兵
			map.add(GolemDungeons.TRIAL, GolemSpawnData.DEEPSLATE_ROOM_RANGED, new TrialConfig().setReward(MazeRoomLootGen.DEEPSLATE_ROOM_RANGED)
			...
			// RIDER: 火箭骑兵+药水兵
			map.add(GolemDungeons.TRIAL, GolemSpawnData.DEEPSLATE_ROOM_RIDER, new TrialConfig().setReward(MazeRoomLootGen.DEEPSLATE_ROOM_RIDER)
			...
			// MIXED: 全兵种混合
			map.add(GolemDungeons.TRIAL, GolemSpawnData.DEEPSLATE_ROOM_MIXED, new TrialConfig().setReward(MazeRoomLootGen.DEEPSLATE_ROOM_MIXED)
					.add(of(LARGE_1, 1), of(HUMANOID_MELEE, 1), of(HUMANOID_RANGED, 1))
	...
	private static SpawnConfig createBase() {
		return new SpawnConfig(DungeonFactionRegistry.REMNANT)
				...
				.mat(ModularGolems.loc("gold"), noArm(30))
	...
	private static SpawnConfig createLv2() {
		return new SpawnConfig(DungeonFactionRegistry.REMNANT)
				...
				.mat(ModularGolems.loc("netherite"), 50)
				.mat(ModularGolems.loc("gold"), noArm(30))
