...
public class GolemSpawnData extends AbstractGolemSpawn {
	...
	public static void gen(ConfigDataProvider.Collector col) {
		...
		col.add(GolemDungeons.TRIAL, STONE_ROOM_MIXED, new TrialConfig().setReward(DILootGen.STONE_ROOM_MIXED)
		...
		// MIXED: 全兵种混合
		col.add(GolemDungeons.TRIAL, MINESHAFT_ROOM_MIXED, new TrialConfig().setReward(DILootGen.MINESHAFT_ROOM_MIXED)
		...
		// MIXED: 全兵种混合
		col.add(GolemDungeons.TRIAL, COPPER_ROOM_MIXED, new TrialConfig().setReward(DILootGen.COPPER_ROOM_MIXED)
		...
		// MIXED: 猪灵+工厂全兵种混合
		col.add(GolemDungeons.TRIAL, DEEPSLATE_ROOM_MIXED, new TrialConfig().setReward(DILootGen.DEEPSLATE_ROOM_MIXED)
		...
		// MIXED: 幽匿全兵种混合
		col.add(GolemDungeons.TRIAL, SCULK_ROOM_MIXED, new TrialConfig().setReward(DILootGen.SCULK_ROOM_MIXED)
